...
.faq-content .answers{background:#e0ebcb;padding:0 15px;margin:5px 0;max-height:0;overflow:hidden;z-index:-1;position:relative;opacity:0;-webkit-transition:.7s ease;-moz-transition:.7s ease;-o-transition:.7s ease;transition:.7s ease}.faq-content .questions:checked~.answers{max-height:500px;opacity:1;padding:15px}
