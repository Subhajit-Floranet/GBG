   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="container690" style="background-color: white">
    ...
    <tr>
        <td style="text-align:center;">
            <p style="font-size:26px; font-weight: normal; text-align:center; line-height:21px; color:#e9724c; padding:50px 20px 0 20px; font-family:verdana;">User Registration</p>
        </td>
    </tr>
    <tr>
        <td style="text-align:center;">
            <p style="font-size:20px; text-align:center; line-height:21px; color:#e9724c; padding:50px 20px 0 20px; font-family:verdana;">Dear {{$data->name}},</p>
        </td>
    </tr>
    <tr>
        ...
        Thank you for signing up with {{ config('global.website_url') }} using your email!
        <br><br>
    ...
    <tr>
        <td valign="middle" style="text-align:center; margin:56px 0 30px 0; display:block;">
            <a href="{{url('/users/verifyemail/'.$data->email_token)}}" style="width:auto; text-align:center; text-decoration:none; margin:0 auto; color:#000000; padding:10px 20px; border-radius:50px; background:#ff6963;">Click Here</a>
        </td>
    </tr>

    <!-- <tr>
        <td style="text-align:center;"><p style="font-size:18px; text-align:center; line-height:20px; color:#444444; padding:30px 20px 0 20px; font-family:Calibri;">Looking forward to your prompt action
        </p></td>
    </tr> -->
    <tr>
        <td style="text-align:center;">
    ...
    <tr>
        <td class="footcont" valign="middle" style="text-align:center;">
            <p style="font-size:18px; text-align:center; line-height:20px; color:#000; padding:30px 20px; font-family:Calibri;">PS. Don’t worry, we will never spam you or share your email or information with anyone!</p>
        </td>
    </tr>
    <tr>
        <td class="footcont" valign="middle" style="text-align:center;">
