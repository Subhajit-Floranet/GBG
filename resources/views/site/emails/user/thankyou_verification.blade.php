...
<body>
   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="container690" style="background-color: white">
    ...
    <tr>
        <td>
            <h1 style="font-size:22px; line-height:26px; color:#e9724c; padding:50px 20px 0 20px; font-family:Calibri;">Dear {{$data->name}},</h1>
        </td>
    </tr>
    <tr>
        <td><h1 style="font-size:30px; line-height:26px; color:#e9724c; padding:30px 20px 0 20px; font-family:Calibri;"><span style="color:#444444;">Welcome to</span> GermanFlorist</h1></td>
    </tr>
    <tr>
        <td><p style="font-size:18px; line-height:20px; color:#444444; padding:30px 20px 0 20px; font-family:Calibri;">
        Thank You for creating a customer account at {{ config('global.website_url') }}.
        <br><br>
        Your user email is: {{$data->email}}
        </p></td>
    </tr>
    <tr>
        <td><p style="font-size:18px; line-height:20px; color:#444444; padding:30px 20px 0 20px; font-family:Calibri;">We look forward to serve you and make you happy.
        </p></td>
    </tr>
    <tr>
        <td>
