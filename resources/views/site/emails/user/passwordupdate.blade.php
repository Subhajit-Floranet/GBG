   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="container690" style="background-color: white">
    ...
    <tr>
        <td style="text-align:center;">
            <p style="font-size:26px; text-align:center; line-height:21px; color:#e9724c; padding:50px 20px 0 20px; font-family:verdana;">Password Updated Successfully!</p>
        </td>
    </tr>
    ...
    <tr>
        <td><p style="font-size:18px; text-align:center; line-height:20px; color:#444444; padding:30px 20px 0 20px; font-family:Calibri;">
            Please <a href="{{url('/contact-us')}}">click here</a> to get in touch with us if you did not change your password.
        </p></td>
    </tr>
