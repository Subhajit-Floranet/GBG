...
<body>
   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="container690" style="background-color: white">
    ...
    <tr>
        <td>
            <p style="font-size:26px; text-align:center; line-height:21px; color:#e9724c; padding:50px 20px 0 20px; font-family:verdana;">Welcome to GermanFlorist</p>
        </td>
    </tr>
    <tr>
        <td>
            <p style="font-size:20px; text-align:center; line-height:26px; color:#e9724c; padding:50px 20px 0 20px; font-family:verdana;">Dear {{$data['name']}},</p>
        </td>
    </tr>
       
    <tr>
        <td><p style="font-size:18px; text-align:center; line-height:20px; color:#444444; padding:30px 20px 0 20px; font-family:Calibri;">
        Thanks for using {{ config('global.website_title') }}
        <br><br>
        Please use below details for next time login:<br /><br />
        Email: {{$data['email']}}<br />
        Password: {{$data['raw_password']}}
        </p></td>
    </tr>
    <!-- <tr>
        <td><p style="font-size:18px; line-height:20px; color:#444444; padding:30px 20px 0 20px; font-family:Calibri;">Looking forward to your prompt action
        </p></td>
    </tr> -->
    <tr>
        <td>
