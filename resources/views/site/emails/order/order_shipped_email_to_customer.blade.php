   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="container690" style="background-color: white">
    ...
    <tr>
        <td style="text-align:center;">
            <h1 style="font-size:26px; text-align:center; line-height:21px; color:#e9724c; padding:50px 20px 0 20px; font-family:verdana;">Your order has been Shipped!</h1>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td><p style="font-size:18px; text-align:center; line-height:21px; color:#444444; padding:30px 20px 0 20px; font-family:Calibri;">
            How's sitting back, relaxing and enjoying going for you?<br><br>
            Your order has been shipped and will be delivered timely!<br><br>
