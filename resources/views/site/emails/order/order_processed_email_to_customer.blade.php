   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="container690" style="background-color: white">
    ...
    <tr>
        <td style="text-align:center;">
            <h1 style="font-size:26px; text-align:center; line-height:21px; color:#e9724c; padding:50px 20px 0 20px; font-family:verdana;">Your order has been processed!</h1>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td><p style="font-size:18px; text-align:center; line-height:21px; color:#444444; padding:30px 20px 0 20px; font-family:Calibri;">
            Your order has been processed and will be delivered timely! Sit back, relax and enjoy life while we take care of your delightful order.
        </p></td>
    </tr>
    <tr>
        <td><p style="font-size:18px; text-align:center; line-height:21px; color:#444444; padding:30px 20px 0 20px; font-family:Calibri;">
            We will keep you updated when the item(s) get shipped and delivered!
        </p></td>
    </tr>
